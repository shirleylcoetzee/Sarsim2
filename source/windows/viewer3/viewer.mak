...
# ---------------------------------------------------------------------------
PROJECT = viewer.exe
OBJFILES = viewer.obj mainview.obj loaddata.obj general.obj vector.obj \
   quickload.obj quikgeneral.obj selectpal.obj
RESFILES = viewer.res
RESDEPEN = $(RESFILES) mainview.dfm loaddata.dfm selectpal.dfm
LIBFILES = 
DEFFILE = 
# ---------------------------------------------------------------------------
