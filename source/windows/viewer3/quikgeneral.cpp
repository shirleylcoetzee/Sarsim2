...
{
  Dest->FileFormat = Src->FileFormat;
  Dest->FileName = Src->FileName;
  Dest->ScriptFile = Src->ScriptFile;
  Dest->FileType = Src->FileType;
  Dest->BytesPerPixel = Src->BytesPerPixel;
  ...
  Dest->MinValueI = Src->MinValueI;
  Dest->MaxValueI = Src->MaxValueI;
  Dest->MinValueQ = Src->MinValueQ;
  Dest->MaxValueQ = Src->MaxValueQ;
  Dest->MinValueMag = Src->MinValueMag;
  Dest->MaxValueMag = Src->MaxValueMag;
  Dest->MinValuePh = Src->MinValuePh;
  Dest->MaxValuePh = Src->MaxValuePh;
  Dest->MinValuePower = Src->MinValuePower;
  Dest->MaxValuePower = Src->MaxValuePower;
}
